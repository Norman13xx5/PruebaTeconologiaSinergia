                    ...
                    <div class="form-row">
                        ...
                        <div class="custom-control custom-checkbox custom-checkbox-circle m-3">
                            ...
                            <div class="col-md-12" id="uno">
                                <input type="text" onkeypress="return filterFloat(event,this);" class="form-control"
                                    id="admon" name="admon" placeholder="Administración" required>
                            </div>
                        </div>
                        ...
                        <div class="custom-control custom-checkbox custom-checkbox-circle m-3">
                            ...
                            <div class="col-md-12" id="dos">
                                <input type="text" onkeypress="return filterFloat(event,this);" class="form-control"
                                    id="retefuente" name="retefuente" placeholder="Retención en la fuente" required>
                            </div>
                        </div>
                        ...
                        <div class="custom-control custom-checkbox custom-checkbox-circle m-3">
                            ...
                            <div class="col-md-12" id="tres">
                                <input type="text" onkeypress="return filterFloat(event,this);" class="form-control"
                                    id="reteica" name="reteica" placeholder="Deducible de reteica" required>
                            </div>
                        </div>
                        ...
                        <div class="custom-control custom-checkbox custom-checkbox-circle m-3">
                            ...
                            <div class="col-md-12" id="cuatro">
                                <input type="text" onkeypress="return filterFloat(event,this);" class="form-control"
                                    id="anticipo" name="anticipo" placeholder="Deducible de anticipo" required>
                            </div>
                        </div>
                        ...
                        <div class="custom-control custom-checkbox custom-checkbox-circle m-3">
                            ...
                            <div class="col-md-12" id="cinco">
                                <input type="text" onkeypress="return filterFloat(event,this);" class="form-control"
                                    id="otros" name="otros" placeholder="Otros deducibles" required>
                                <label class="form-label" for="observacionDeducible">Observación:</label>
                                <textarea onKeyPress="if(this.value.length==1000)return false;" class="form-control" id="observacionDeducible"
                                    name="observacionDeducible" rows="5" style="height: 77px;" required></textarea>
                            </div>
                        </div>
