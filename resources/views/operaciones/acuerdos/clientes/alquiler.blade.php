...
@section('title', 'Acuerdos Alquiler Clientes')
...
@push('modals')
    <x-ModalForm title="Agregar acuerdo de Alquiler" description="Formulario para agregar los acuerdos de alquiler." form>
        <div class="form-row">
            ...
            <input type="hidden" id="clienteProveedor" name="clienteProveedor" value="cliente">
...
@push('scripts')
    <script>
        $(document).ready(async () => {
            await buildDataTable("acuerdos/clientes/alquiler",
                [{
                        data: "id"
                    },
                    {
